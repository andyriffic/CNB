    ...
    Object.keys(scores).forEach(counterId => {
        mappedScores[scores[counterId].name] = {
            ...
            add: (value, currentScores) => {
                return putCounterUpdate(counterId, 'INCREMENT', value)
                    .then(result => {
            ...
            subtract: (value, currentScores) => {
                return putCounterUpdate(counterId, 'DECREMENT', value)
                    .then(result => {
                        return getUpdateStateFunction(
                            counterId, 
                            scores, 
...
function getUpdateStateFunction(counterId, serverScores, localScores, updatedResult, setScores) {
