...
export const DYNAMO_DB_COUNTERS_TABLE_NAME = process.env.DYNAMO_DB_COUNTERS_TABLE_NAME || '';
export const DYNAMO_DB_MATCHUPS_TABLE_NAME = process.env.DYNAMO_DB_MATCHUPS_TABLE_NAME || '';
